...
function CartScreen(){
  ...
  return(
      <Layout title="Shopping Cart">
          ...
          {cartItems.length === 0 ? 
            <Box>
                <Typography> Cart is empty. <NextLink href="/" passHref><Link>Go Shopping</Link></NextLink></Typography>
            </Box>:
             (
                       ...
                       <Grid item md={3} xs={12}>
                            <Card>
                                <List>
                                    ...
                                    <ListItem>
                                        <Button onClick={()=>{router.push('/shipping')}} fullWidth color="secondary" variant="contained">
                                             CheckOut
                                        </Button>
                                    </ListItem>
                                </List>
